...
assert automata_BrackOpen("") == RESULT_NOT_ACCEPTED

assert automata_BrackOpen("[") == RESULT_ACCEPTED

assert automata_BrackOpen("312asd1") == RESULT_TRAP